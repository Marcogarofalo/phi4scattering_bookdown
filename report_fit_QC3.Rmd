...
```{r, echo=FALSE}
file=sprintf("../fit_out/QC3_N2_fit_data.txt")
df<- read.table(file, header=FALSE, fill=TRUE)
...
```{r , child="../fit_out/QC3_N4_1par_fit_P.tex", eval=TRUE}
```


```{r, echo=FALSE, results='asis'}
plot_QC3(basename="../fit_out/QC3_N4_1par",N=4)
...
```{r , child="../fit_out/QC3_N4_latt_2par_fit_P.tex", eval=TRUE}
```


```{r, echo=FALSE, results='asis', eval=TRUE}

plot_QC3(basename="../fit_out/QC3_N4_latt_2par",N=4)
...
plot_QC3(basename="../fit_out/QC3_N5_1par",N=5)
```
...
```{r , child="../prova/QC3_N3_latt_1par_fit_P.tex", eval=TRUE}
```
...
# datalist2_1 = list()
# for (n in c(1:N)){
#  lab2_1<-"P[0]=1e+3 Nsteps=40"
#  file=sprintf("../prova/kiso_P1e+3_n%d_L.txt", n-1)
...
```{r , child="../fit_out/QC3_N5_latt_2par_fit_P.tex", eval=TRUE}
```


```{r, echo=FALSE, results='asis'}

plot_QC3(basename="../fit_out/QC3_N5_latt_2par",N=5)
