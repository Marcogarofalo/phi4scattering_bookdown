...
```{r , child="../../g0.1/fit_out/poly_E3andE1_N6_fit_P.tex", eval=TRUE}
```

```{r, echo=FALSE}
file=sprintf("../../g0.1/fit_out/poly_E3andE1_N6_fit_data.txt")
...
file=sprintf("../../g0.1/fit_out/poly_E3andE1_N6_fit_out_n%d_L.txt",n-1)
